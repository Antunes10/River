...
=== main ===
#background:city
#speaker: #layout:left:oak_scared #layout:middle:tails_scared #layout:sparks:sparks_scared_m
~unlockImage(17)
...
The mist we passed isn't from natural causes.
It's formed from the dust and smoke coming from this destruction.
...
What are we going to do, Mr.Tails?
...
=== choice_panel2 ===
    ...
    +[Try to lift the wheelbarrow]
        ...
        #speaker:Tails #portrait:tails_default #layout:middle:tails_default
        Oak, help me lift this thing so she can get out of there.
        #speaker: #layout:left:oak_sad
...
=== try_to_find_rope_continuation ===
    +[Let go of the Wheelbarrow]
        ...
        #speaker:Tails #portrait:tails_default
        I’m alright, Sparks.
        #layout:sparks:sparks_happy_m #speaker:
        ...
        #enviroSound:villageExplosions
        #speaker: #layout:left:tails_scared #layout:middle:default #layout:sparks:default #layout:middle_right:default
        Suddently another explosion hits, covering everything with dust.
        Tails is sent flying against the wheelbarrow.
        The sound is snuffed out of the world, leaving a high pitching sound.
        Tails can't see anything.
...
=== try_to_salvage_food ===
    ...
    #speaker: #layout:sparks:default #layout:left:default
    ...
    +[Get out]
        ...
        #enviroSound:villageExplosions
        #speaker: #layout:left:tails_scared #layout:middle:default #layout:sparks:default
        Suddently another explosion hits, covering everything with dust.
        Tails is sent flying against the wheelbarrow.
        The sound is snuffed out of the world, leaving a high pitching sound.
        Tails can't see anything.
...
#speaker: #layout:left:oak_sad #layout:middle:tails_sad #layout:sparks:sparks_sad_m
...
#speaker: #enviroSound:villageExplosions
Suddenly another explosion blows right near them, sending debris everywhere.
#speaker:Oak #portrait:oak_scared #layout:left:oak_scared #layout:middle:tails_scared
We must take shelter!
We won’t survive if we stay out in the open!
#enviroSound:villageExplosions
#speaker: #layout:left:tails_scared #layout:middle:default #layout:sparks:default #layout:middle_right:default
