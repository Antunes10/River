...
Tails: Rise and shine, sleepyhead.
...
+[Look for the dog]
    ...
    Tails: We… I’m just passing by…
    Tails: I’m not looking for trouble, please let me go.
    #speaker:
    The dog raises one eyebrow.
    #speaker:Oak #portrait:oak_default
    Oak: Why would old Oak prevent you gentleman from leaving?
    #speaker:Tails #portrait:tails_scared
    Tails: I… don’t know…
    Tails: Because you want to eat me?
    #speaker:Oak #portrait:oak_default
    ...
    Tails: I am Tails...
    Tails: Together with a small firefly I’m trying to escape this calamity and find refuge to the West.
    Tails: We wandered into this village to spend the night.
    #speaker: #layout:right:oak_default_m
    The dog smiles.
    #speaker:Oak #portrait:oak_happy
    Oak: What a marvellous pair you make.
    ...
    Tails: And what are you doing here… Old Oak?
    ...
    #speaker:Tails #portrait:tails_default 
    Tails: Forgive me. What are you doing here, Oak?
    #speaker:Oak #portrait:oak_default 
    ...
    ++[Offer to help]
        ...
        #speaker:Tails #portrait:tails_default
        Tails: I could help you find him.
        #speaker: #layout:right:oak_happy_m
        The dog smiles.
        #speaker:Oak #portrait:oak_happy
        Oak: That would be most kind.
        #speaker:Tails #portrait:tails_default
        Tails: Could you give me a description?
    ...
    ++[Wish him luck and go on your way]
        #speaker:Tails
        Tails: I hope you find your human friend. I have to go now.
        #speaker:
...
+[Get away from the village]
	...
	#speaker:Tails #portrait:tails_default
	Tails: Come on Sparks, it's time to get on our way.
	#speaker: 
    ...
    #speaker:Tails #portrait:tails_scared
    Tails: Let’s get away from here!
-
