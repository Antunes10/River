...
I don’t like dogs. They have huge mouths full of teeth.
And humans use them to keep other animals away.
#speaker:
Tails shared his concern.
He had seen mice teared to shreds by angry mongrels.

+[Look for the dog.]
    #speaker: #layout:middle:tails_default #layout:left:nimbus_scared
    The mouse gathers his courage and steps forward.
    #speaker:Nimbus #portrait:nimbus_scared 
    Are you mad? We must get out of here!
    #speaker:
    ...
    ++[Go talk to the dog]
        #speaker:Tails #portrait:tails_default
        We don’t know him. Perhaps he can help us.
        #speaker:Nimbus #portrait:nimbus_scared
        That’s stupid and you going to get us both killed!
        #speaker:Tails #portrait:tails_default
    ...
    #speaker:Oak #portrait:oak_default_noHat #layout:right:oak_default_noHat #music:oak
