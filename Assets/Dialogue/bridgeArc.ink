...
=== main ===
#speaker: #layout:left:tails_default #layout:right:sparks_happy
...
Tails: All thanks to you, Sparks.
#speaker:
The young firefly glows with happiness.
#speaker:Tails #portrait:tails_happy 
Tails: It’s good to be around nature again. At least this place seems to be unscathed.
#speaker:Sparks #portrait:sparks_sad #layout:right:sparks_sad
Sparks: Yes, tunnels and stone forests can be quite depressing.
#speaker:Sparks #portrait:sparks_default #layout:right:sparks_default
Sparks: Specially if they are all reduce to rumble, with no life around.
...
#speaker:Tails #portrait:tails_happy #layout:left:tails_happy
Tails: Thank you for your help, Sparks. I think this is where we part ways.
...
Tails: Well, I will keep going West.
Tails: To a place where I can find my kind again, without fires or explosions.
Tails: A place of peace.
#speaker:Sparks #portrait:sparks_happy #layout:right:sparks_happy
Sparks: That seems nice!
Sparks: Can I go with you to this enchanted place?
...
#speaker: #layout:left:tails_sad #layout:right:sparks_scared
...
Tails: Something is wrong, stay close Sparks.
#speaker:
...
+[Help the Bird]
    ...
    #speaker:Bird #portrait:sky_scared #layout:middle:sky_scared
    Bird: Help me please! I can’t get out! I’ve been trying for hours.
    #speaker:Tails #portrait:tails_sad #layout:left:tails_sad
    Tails: Don’t worry we are going to help you. Just stay still or you’re going to hurt yourself even more.
    Blood was already running down one of his wings.
    
    ->ChoicePanel

+[Ignore the Bird]
    #speaker: #layout:left:sky_sad #layout:middle:tails_sad #layout:right:sparks_sad
    ...
    Tails: I’m sorry, we can’t help you.
    #speaker:Bird #portrait:sky_scared #layout:left:sky_scared
    Bird: No please, no! Don’t leave me here!
    #speaker:
    ...
    Sparks: Why did we leave him?
    #speaker:Tails #portrait:tails_sad
    Tails: Sometimes we can’t save those who need saving.
    #speaker:
...
#speaker:Tails #portrait:tails_sad #layout:left:tails_sad
Tails: Sparks, help me find something to cut these wires.
#speaker:Sparks #portrait:sparks_default #layout:right:sparks_default
Sparks: You got it!
...
#speaker:Bird #portrait:sky_scared
Bird: Quickly, please! Or we’re going to be buried here.
#speaker: #layout:right:sparks_scared
The young bug came back in a hurry.
#speaker:Sparks #portrait:sparks_scared
Sparks: There are huge metal rocks with wheels, traversing the bridge.
Sparks: With humans all around.
#speaker:Tails #portrait:tails_scared
Tails: Get the helmet ready, then. We must move fast.
#speaker:
...
=== KeepTrying ===
#speaker: #layout:middle:sky_sad #layout:left:tails_sad #layout:right:sparks_sad
...
Bird: Darned, I can’t move my right wing!
#speaker:
...
#speaker:Tails #portrait:tails_default #layout:left:tails_default
Tails: Now its not a time for you to worry about it.
Tails: I will patch it up in a bit, but our focus should be on getting away from this place.
#speaker:Sky #portrait:sky_default
Sky: Where are you going?
#speaker:Sparks #portrait:sparks_default #layout:right:sparks_default
Sparks: West. Towards the enchanted land.
#speaker:Sky #portrait:sky_default 
Sky: Guess I’ll accompany you..
Sky: For now…
#speaker:
Tails understood his reservation.
#speaker:Tails #portrait:tails_happy #layout:left:tails_happy
Tails: You are welcome to.
