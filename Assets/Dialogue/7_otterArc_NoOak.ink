...
Nimbus: It’s going to take ages just us three. Perhaps the helmet served its purpose.
#speaker:Sparks #portrait:sparks_default
...
+ [Abandon the helmet and go on foot.]
    ...
    #speaker:Nimbus #portrait:nimbus_default #layout:left:nimbus_default
    Nimbus: I don’t see humans around, but perhaps they have left something behind…
    #speaker:
    ...
    Nimbus: This is bad… We need to turn back!
    #speaker:Tails #portrait:tails_default 
...
+ [Try to breach the dam.]
    ...
    #speaker:Sparks #portrait:sparks_default
    Sparks: Oh…
    Sparks: My name is Sparks, and this is my friends Tails and Nimbus.
    #speaker:Hazel #portrait:hazel_happy
    ...
    Nimbus: Good afternoon, Hazel.
    Nimbus: We are trying to get across with our shell, but we can’t find a way through.
    Nimbus: Could you be help us? You seem to know this place quite well.
    #speaker:Hazel #portrait:hazel_happy
    ...
    #speaker:Nimbus #portrait:nimbus_default #layout:right:nimbus_default_m
    Nimbus: We can only image what you have seen.
    #speaker:
    ...
    #speaker:Sparks #portrait:sparks_default 
    Sparks: You’re really kind Miss Hazel!
