        ...
        case NEXT_MUSIC_TAG:
          switch (tagValue)
          {
            ...
            case "respite":
              ...
              break;
			case "hazel":
			  AudioManager.Instance.PlayNarrativeMusic(AudioManager.MusicsNarrative.hazel);
			  break;
			case "swamp":
        ...
        case ENVIRONMENT_TAG:
           switch (tagValue)
           {
            ...
            case "swamp":
                ...
                break;
						case "cityWar":
							AudioManager.Instance.PlayEvironmentSoundOneShot(AudioManager.EnvironmentSounds.cityWar);
							break;
						case "silence":
